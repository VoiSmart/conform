defmodule ConfigTest do
  ...
  test "README example" do
    ...
    expected = [
      evl_daemon: [storage_engines: [[type: "memory", maximum_events: "100"]]],
      lager: [
        handlers: [
      ...
      my_app: [
        ...
        complex_list: [
          first: [age: 20, username: "username1"],
  ...
  test "logger example" do
    ...
    assert [
             logger: [
               backends: [:console, {ExSyslog, :exsyslog_error}, {ExSyslog, :exsyslog_debug}]
             ]
           ] = config
  ...
  test "can translate config.exs + schema + conf with nested lists to sys.config" do
    ...
    assert [
             my_app: [
               rx_pattern: [~r/[A-Z]+/],
               sublist: [[opt1: "val1", opt2: "val two"], [opt1: "val3", opt2: "val-4"]]
             ]
           ] == sysconfig
  end
